        ...
        <div className="py-8 lg:py-20 flex items-center justify-center px-0 lg:px-8">
            ...
            <div className="relative w-full max-w-[1400px] bg-white rounded-none lg:rounded-[6rem] shadow-none lg:shadow-[0_40px_100px_-30px_rgba(0,0,0,0.08)] border-y border-gray-100 lg:border border-x-0 lg:border-x p-8 lg:p-20 overflow-hidden">
                ...
                <div className="mt-16 lg:mt-24 text-center">
                    <Link
                        to="/products"
                        className="group relative inline-flex items-center gap-6 px-12 py-5 bg-white border border-agri-green rounded-full overflow-hidden transition-all duration-500 hover:border-agri-green hover:shadow-[0_15px_30px_-10px_rgba(0,166,81,0.2)]"
                    >
                        <div className="absolute inset-0 w-0 bg-agri-green transition-all duration-500 ease-out group-hover:w-full" />
                        
                        <div className="relative z-10 flex items-center gap-4 transition-colors duration-500 group-hover:text-white text-gray-900">
                            <span className="text-[11px] lg:text-xs font-black uppercase tracking-[0.3em] ml-2">
                                {t('productSlider.view_all')}
                            </span>
                            
                            <div className="flex items-center justify-center w-8 h-8 lg:w-10 lg:h-10 bg-agri-green text-white rounded-full transition-all duration-500 group-hover:bg-white group-hover:text-agri-green group-hover:rotate-[360deg]">
                                <svg
