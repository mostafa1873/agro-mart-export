...
const resources = {
    en: {
        translation: {
            ...
            whatsapp: {
                ...
                support: "Zayat Support"
            },
            home: {
                seo_title: "Zayat Export | Premium Egyptian Agricultural Products",
                ...
                hero_desc: "ZAYAT Export delivers premium agricultural products with a commitment to quality.",
            ...
            about: {
                hero: {
                    seo_title: "About Us | Zayat Export Story & Values",
                    seo_description: "Discover Zayat Export's journey in bringing premium Egyptian produce to the world. Our commitment to quality, sustainability, and global standards.",
                    badge: "Our Story",
                    title1: "Roots in",
                    title2: "Egyptian Soil",
                    desc1: "Al-Zayyat Export is more than just a company; it is a bridge connecting Egypt’s rich agricultural heritage with the global market's demand for premium quality.",
                ...
                values: {
                    title: "Our Values",
                    desc: "What makes Al-Zayyat the preferred partner for international importers.",
            ...
            contact: {
                ...
                seo_title: "Contact Us | Zayat Export - Premium Produce",
            ...
            footer: {
                ...
                exports: ["Fresh Onions", "Valencia Oranges", "Strawberries", "Potatoes"],
    ...
    ar: {
        translation: {
            ...
            home: {
                seo_title: "شركة الزيات للتصدير | أجود المحاصيل الزراعية المصرية",
                ...
                hero_desc: "تقدم شركة الزيات للتصدير منتجات زراعية فاخرة مع التزام تام بأعلى معايير الجودة.",
            ...
            about: {
                hero: {
                    seo_title: "من نحن | شركة الزيات للتصدير الزراعي",
                    seo_description: "تعرف على رحلة شركة الزيات في تصدير أفضل المحاصيل المصرية للعالم. نلتزم بأعلى معايير الجودة والاستدامة في الزراعة والتوريد.",
                    badge: "قصتنا",
                    title1: "جذورنا في",
                    title2: "الأرض المصرية",
                    desc1: "شركة الزيات للتصدير ليست مجرد شركة؛ بل هي جسر يربط بين التراث الزراعي الغني لمصر ومتطلبات السوق العالمية للجودة الفائقة.",
                ...
                values: {
                    title: "قيمنا",
                    desc: "ما يجعل الزيات الشريك المفضل للمستوردين العالميين.",
                    v1_title: "جودة نقية",
            ...
            contact: {
                ...
                seo_title: "اتصل بنا | شركة الزيات للتصدير الزراعي",
                seo_description: "تواصل مع شركة الزيات لتصدير أجود المحاصيل الزراعية المصرية من بصل وبرتقال وفواكه إلى جميع أنحاء العالم.",
                form: {
                ...
                info: {
                    ...
                    address: "طريق الإسكندرية الصحراوي، الجيزة، مصر."
                }
            },
            footer: {
                description: "رائدون في تصدير الأجود من المحاصيل المصرية. جودة، نضارة، وانتشار عالمي.",
                quick_links: "روابط سريعة",
                key_exports: "أهم الصادرات",
                contact_us: "تواصل معنا",
                links: ["الرئيسية", "عن الشركة", "منتجاتنا", "اتصل بنا"],
                exports: ["البصل الطازج", "برتقال فالنسيا", "الفراولة", "البطاطس"],
    ...
    it: {
        translation: {
            ...
            whatsapp: {
                ...
                support: "Supporto Zayat"
            },
            home: {
                seo_title: "Zayat Export | Prodotti Agricoli Egiziani di Qualità",
                ...
                hero_desc: "Al-Zayyat Export offre prodotti agricoli premium con un impegno totale verso i più alti standard di qualità.",
            ...
            about: {
                hero: {
                    seo_title: "Chi Siamo | La Storia di Zayat Export",
                    seo_description: "Scopri il percorso di Zayat Export nel portare i migliori prodotti agricoli egiziani nel mondo. Il nostro impegno per la qualità e la sostenibilità.",
                    badge: "La Nostra Storia",
                    title1: "Radici nella",
                    title2: "Terra Egiziana",
                    desc1: "Al-Zayyat Export non è solo un'azienda; è un ponte che collega il ricco patrimonio agricolo dell'Egitto con le esigenze di alta qualità del mercato globale.",
            ...
            contact: {
                ...
                seo_title: "Contattaci | Zayat Export - Prodotti Egiziani",
                seo_description: "Contatta Zayat Export per le migliori cipolle, arance e frutta fresca egiziana esportata in tutto il mondo.",
                form: {
                ...
                info: {
                    ...
                    address: "Strada Deserto Alessandria, Giza, Egitto."
                }
            },
            footer: {
                ...
                key_exports: "Principali Esportazioni",
                contact_us: "Contattaci",
                links: ["Home", "Chi Siamo", "Prodotti", "Contatti"],
                exports: ["Cipolle Fresche", "Arance Valencia", "Fragole", "Patate"],
...
i18n
    ...
    .init({
        resources,
        // بنخلي الكود صغير عشان يتوافق مع "ar", "en", "it"
